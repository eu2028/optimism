...
type mockSyncControl struct {
	signalNextL1Fn func(ctx context.Context, ref1 eth.BlockRef, ref2 eth.BlockRef) (managed.DerivedPair, error)
}

func (m *mockSyncControl) SignalNextL1(ctx context.Context, ref1 eth.BlockRef, ref2 eth.BlockRef) (managed.DerivedPair, error) {
	if m.signalNextL1Fn != nil {
		return m.signalNextL1Fn(ctx, ref1, ref2)
	}
	return managed.DerivedPair{}, nil
}

func (m *mockSyncControl) AnchorPoint(ctx context.Context) (managed.DerivedPair, error) {
	return managed.DerivedPair{}, nil
}
